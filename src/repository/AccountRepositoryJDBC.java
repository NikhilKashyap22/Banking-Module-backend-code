...
public class AccountRepositoryJDBC implements IAccountRepository{
	private static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/accounts"; // replace with your DB URL
    private static final String DB_USER = "root"; // replace with your DB
    private static final String DB_PASSWORD = "Nik@kashy22"; // replace with your DB password
